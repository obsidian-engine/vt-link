...
export class RegionSet {
  ...
  toString(): string {
    const regionNames = this.regions.map(region => {
      switch (region) {
        case RegionCode.Hokkaido: return '北海道';
        case RegionCode.Tohoku: return '東北';
        case RegionCode.Kanto: return '関東';
        case RegionCode.Chubu: return '中部';
        case RegionCode.Kansai: return '関西';
        case RegionCode.Chugoku: return '中国';
        case RegionCode.Shikoku: return '四国';
        case RegionCode.Kyushu: return '九州';
        case RegionCode.Okinawa: return '沖縄';
        case RegionCode.Unknown: return '不明';
