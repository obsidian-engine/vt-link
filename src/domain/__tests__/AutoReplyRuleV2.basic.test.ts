...
describe('AutoReplyRuleV2', () => {
  describe('create', () => {
    it('should create a new rule with valid parameters', () => {
      ...
      const rule = AutoReplyRuleV2.create('rule-1', 'account-1', 'Test Rule', 1, trigger, response);
    ...
    it('should throw error when priority is negative', () => {
      ...
      expect(() => {
        AutoReplyRuleV2.create('rule-1', 'account-1', 'Test Rule', -1, trigger, response);
  ...
  describe('updateName', () => {
    it('should create new instance with updated name', () => {
      ...
      const rule = AutoReplyRuleV2.create('rule-1', 'account-1', 'Old Name', 1, trigger, response);
