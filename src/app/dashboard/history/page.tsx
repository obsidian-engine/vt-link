            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900 dark:text-white">
                    {campaigns.reduce((sum, c) => sum + (c.failedCount || 0), 0).toLocaleString()}
                  </dd>
                </dl>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900 dark:text-white">
                    {campaigns.length > 0 
                      ? Math.round((campaigns.reduce((sum, c) => sum + (c.sentCount || 0), 0) / 
                          (campaigns.reduce((sum, c) => sum + (c.sentCount || 0) + (c.failedCount || 0), 0) || 1)) * 100)
                      : 0
                    }%
                  </dd>
                </dl>
          ...
          <div key={i} className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <div className="h-4 w-16 bg-gray-200 dark:bg-gray-600 rounded animate-pulse mb-2"></div>
